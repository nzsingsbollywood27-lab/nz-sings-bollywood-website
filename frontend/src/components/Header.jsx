...
export const Header = () => {
    ...
    const nav = content.navigation || navigationConfig;
        ...
        >
            <div className="mx-auto flex h-[70px] max-w-7xl items-center justify-between px-4 sm:h-[76px] sm:px-5 md:px-8">
                <a href="#home" data-testid="header-logo-link" aria-label="NZ Sings Bollywood – home" className="flex items-center">
                    <img src={site.brandTitleHeaderImage} alt="NZ Sings Bollywood – 90s with 90" className="h-8 w-auto sm:h-10 md:h-12" />
                </a>
                ...
                <div className="flex items-center gap-2 sm:gap-3 md:gap-4">
                    <div className="hidden items-center gap-3 md:flex">
                        <a href={safeHref(social.instagram)} data-testid="header-instagram-link" aria-label="Instagram" className="text-zinc-400 transition-colors duration-300 hover:text-[#d4af37]">
                            <Instagram className="h-[18px] w-[18px]" />
                        </a>
                        <a href={safeHref(social.facebook)} data-testid="header-facebook-link" aria-label="Facebook" className="text-zinc-400 transition-colors duration-300 hover:text-[#d4af37]">
                    ...
                    >
                        ...
                        <div className="mt-8 flex items-center justify-between">
                            <div className="flex items-center gap-5">
                                <a href={safeHref(social.instagram)} data-testid="mobile-instagram-link" aria-label="Instagram" className="text-zinc-400 hover:text-[#d4af37]">
                                    <Instagram className="h-5 w-5" />
                                </a>
                                <a href={safeHref(social.facebook)} data-testid="mobile-facebook-link" aria-label="Facebook" className="text-zinc-400 hover:text-[#d4af37]">
