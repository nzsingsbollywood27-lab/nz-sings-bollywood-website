                ...
                <div className="mt-8 grid grid-cols-1 items-stretch gap-5 sm:grid-cols-3">
                    {organisersConfig.map((org, i) => (
                        ...
                        >
                            ...
                            {org.logo ? (
                                <span className="relative flex h-[104px] w-full items-center justify-center">
                                    <img
                                        src={org.logo}
                                        alt={org.name}
                                        className={`max-h-[96px] w-auto max-w-[88%] object-contain transition-transform duration-300 group-hover:scale-[1.03] ${org.logoClassName || ""}`}
                                    />
                                </span>
                            ) : (
