                    ...
                    <div className="mt-8 grid grid-cols-1 items-stretch gap-5 sm:grid-cols-3">
                        {organisers.map((org, i) => (
                            <a
                                ...
                                aria-label={org.name}
                                title={org.name}
                                className="group relative flex min-h-[168px] items-center justify-center overflow-hidden rounded-2xl border border-[#d4af37]/25 bg-white px-5 py-5 shadow-[0_16px_48px_rgba(0,0,0,0.10)] transition-all duration-300 hover:-translate-y-1 hover:border-[#d4af37]/75 hover:shadow-[0_24px_65px_rgba(0,0,0,0.16)]"
                            >
                                ...
                                {org.logo ? (
                                    <span className="relative flex h-[132px] w-full items-center justify-center">
                                        <img
                                            src={org.logo}
                                            alt={org.name}
                                            className="max-h-[124px] w-auto max-w-[96%] object-contain transition-transform duration-300 group-hover:scale-[1.03]"
                                        />
                                    </span>
                                ) : (
